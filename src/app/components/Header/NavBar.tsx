...
const NavBar: React.FC = () => {
  return (
    <nav data-layername="navBar" className="flex flex-wrap gap-8 items-center self-center px-9 py-3 ml-2 bg-white border border-solid border-neutral-200 rounded-[54px] max-md:px-5 max-md:max-w-full">
      ...
      <div className="flex flex-wrap gap-10 items-center self-stretch my-auto min-w-[240px] max-md:max-w-full">
        ...
        <div className="flex gap-6 items-center self-stretch my-auto text-base font-medium leading-none text-center text-white">
          <button data-layername="buttons" className="gap-2 text-sm self-stretch px-6  py-3 my-auto bg-indigo-500 rounded-[48px] max-md:px-5">
            Agendar Consulta
          </button>
        </div>
      </div>
